...
/* I have modified java.util.UUID for the purposes of using it with firebase. It needs to have a default constructor and setters for the most significant and least significant bits
 *
 */
...
public final class MyUUID implements java.io.Serializable, Comparable<MyUUID> {
     ...
     */
    public static MyUUID nameUUIDFromBytes(byte[] name) {
        MessageDigest md;
        try {
     ...
     *
     */
    public static MyUUID fromString(String name) {
        ...
        return new MyUUID(mostSigBits, leastSigBits);
    }
